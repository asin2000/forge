...
from forge_common import synthetic_data  # noqa: E402
...
message = agent.run(
    ...
    variables={
        ...
        "approved_parts_excerpt": json.dumps(
            synthetic_data.parts_for_discrepancy("DSC-0042"), indent=1
        ),
    },
...
if kind != "sourcing_report.v3":
    print(f"ADK SMOKE: FAIL ({kind})")
    sys.exit(1)
print("ADK SMOKE: PASS — contract-valid sourcing_report.v3 via ADK Runner on Vertex")
